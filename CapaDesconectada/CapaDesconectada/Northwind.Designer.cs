...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustumerID", global::System.Data.SqlDbType.NChar, 5, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int FillByCustomerID(Northwind.CustomersDataTable dataTable, string CustumerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CustumerID == null)) {
                throw new global::System.ArgumentNullException("CustumerID");
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(CustumerID));
            }
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        public virtual Northwind.CustomersDataTable GetDataByCustomerID(string CustumerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CustumerID == null)) {
                throw new global::System.ArgumentNullException("CustumerID");
            }
